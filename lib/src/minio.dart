...
import 'package:s3_dart/models.dart';
import 'package:s3_dart/src/minio_client.dart';
import 'package:s3_dart/src/minio_errors.dart';
import 'package:s3_dart/src/minio_helpers.dart';
import 'package:s3_dart/src/minio_poller.dart';
import 'package:s3_dart/src/minio_sign.dart';
import 'package:s3_dart/src/minio_stream.dart';
import 'package:s3_dart/src/minio_uploader.dart';
...
class Minio {
  ...
  /// Using this URL, the client can delete the object without credentials.
  ///
  /// - [bucket]: name of the bucket
  /// - [object]: name of the object
  /// - [expires]: expiry in seconds (optional, default 7 days)
  Future<String> presignedDeleteObject(
    String bucket,
    String object, {
    int? expires,
  }) {
    MinioInvalidBucketNameError.check(bucket);
    MinioInvalidObjectNameError.check(object);
    return presignedUrl('DELETE', bucket, object, expires: expires);
  }
